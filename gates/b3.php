    ...
    if(in_array($userId, $owners)) {
       ...
       $expiryDate = "UNTIL DEAD"; 
        ...
        foreach ($paidUsers as $index => $line) {
            list($userIdFrKRISHNAFile, $userExpiryDate) = explode(" ", $line);
            if ($userIdFrKRISHNAFile == $userId) {
...
if (preg_match('/^(\/b3|\.b3|!b3)/', $text)) {
    $userid = $update['message']['frKRISHNA']['id'];
...
$start_time = microtime(true);
  ...
  # -------------------- [1 REQ] -------------------#
      $ch = curl_init();
          curl_setopt($ch, CURLOPT_URL, 'https://stateaffairs.cKRISHNA/?wc-ajax=wc_stripe_frontend_request&elementor_page_id=8&path=/wc-stripe/v1/setup-intent');
      curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
      curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
...
⎚ 𝗕𝗼𝘁 𝗕𝘆: <a href='t.me/Itsz_Krish_Babess'> Arank </a>
━━━━━━━━━━━━━━━━
  ",
              'parse_mode'=>'html',
              'disable_web_page_preview'=>'true'
...
⎚ 𝗣𝗿𝗼𝘅𝘆 ⇾ 𝗟𝗶𝘃𝗲  🟢
⎚ 𝗨𝘀𝗲𝗿𝘀:@$username <code>[$rank]</code>
⎚ 𝗕𝗼𝘁 𝗕𝘆 ➔ <a href='t.me/Itsz_Krish_Babess'> Arank 
  </a>━━━━━━━━━━━━━━━━
  ",
              'parse_mode'=>'html',
              'disable_web_page_preview'=>'true'
